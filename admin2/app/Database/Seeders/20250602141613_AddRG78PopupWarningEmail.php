...
class AddRG78PopupWarningEmail extends SeederTranslation
{
    private const TRIGGER_NAME = "RG78";
    ...
    protected array $data = [
        'en' => [
            ...
            "mail." . self::TRIGGER_NAME . ".popup.ignored.content" => '<p>Dear __USERNAME__,</p>
                <p>You are currently one of the __TOP_LOSERS_COUNT__ highest losing customers who have registered in the last __MONTHS__ months. We encourage you to take a moment to reflect on your recent activity and ensure you\'re playing within comfortable limits.</p>
