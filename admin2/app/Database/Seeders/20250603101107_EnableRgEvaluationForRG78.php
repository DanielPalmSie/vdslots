...
class EnableRgEvaluationForRG78 extends Seeder
{
    private string $config_name = "RG78-evaluation-in-jurisdictions";
    private string $dynamic_action_state_config_name = "RG78-evaluation-last-step-action-state";
