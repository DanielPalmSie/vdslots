...
class EnableRgEvaluationForRG80 extends Seeder
{
    private string $config_name = "RG80-evaluation-in-jurisdictions";
    private string $dynamic_action_state_config_name = "RG80-evaluation-last-step-action-state";
